...
export default function MetricDetails({metric}: MetricGraphProps) {
    ...
    function MetricDetailsPanel(){
        return(
            ...
            >
                <Box>
                    <Button onClick={()=>{setBeginDiff(48*3600); setEndDiff(24*3600);}}>Prev day</Button>
                    <Button onClick={()=>{setBeginDiff(48*3600); setEndDiff(0);}}>2 days</Button>
                    <Button onClick={()=>{setBeginDiff(24*3600); setEndDiff(0);}}>1 day</Button>
                    <Button onClick={()=>{setBeginDiff(12*3600); setEndDiff(0);}}>12 hours</Button>
                    <Button onClick={()=>{setBeginDiff(6*3600); setEndDiff(0);}}>6 hour</Button>
                    <Button onClick={()=>{setBeginDiff(3*3600); setEndDiff(0);}}>3 hours</Button>
                    <Button onClick={()=>{setBeginDiff(3600); setEndDiff(0);}}>1 hour</Button>
                    <Button onClick={()=>{setBeginDiff(1800); setEndDiff(0);}}>30 min</Button>
                </Box>
                <IconButton
                    onClick={()=>refetch({
                        metric,
